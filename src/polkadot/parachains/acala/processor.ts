...
export const SUBSQUID_NETWORK =
  process.env["SUBSQUID_NETWORK_ACALA"] || "acala";

export const START_BLOCK = process.env["START_BLOCK_ACALA"]
  ? parseInt(process.env["START_BLOCK_ACALA"])
  : 7382962;

const RPC_URL =
  process.env["RPC_ACALA"] || "wss://acala-rpc-3.aca-api.network/ws";
