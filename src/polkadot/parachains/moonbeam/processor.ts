...
const SUBSQUID_NETWORK =
  process.env["SUBSQUID_NETWORK_MOONBEAM"] || "moonbeam-substrate";

const START_BLOCK = process.env["START_BLOCK_MOONBEAM"]
  ? parseInt(process.env["START_BLOCK_MOONBEAM"])
  : 8165770;

const RPC_URL = process.env["RPC_MOONBEAM"] || "wss://moonbeam.ibp.network";
