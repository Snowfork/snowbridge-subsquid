...
export const functions = {
    ...
    mintForeignToken: fun("0x017b7311", "mintForeignToken(bytes)", {"data": p.bytes}, ),
    ...
    registerForeignToken: fun("0xae8a4d98", "registerForeignToken(bytes)", {"data": p.bytes}, ),
    ...
    transferNativeToken: fun("0x93dbdf1d", "transferNativeToken(bytes)", {"data": p.bytes}, ),
...
export type MintForeignTokenParams = FunctionArguments<typeof functions.mintForeignToken>
export type MintForeignTokenReturn = FunctionReturn<typeof functions.mintForeignToken>
...
export type RegisterForeignTokenParams = FunctionArguments<typeof functions.registerForeignToken>
export type RegisterForeignTokenReturn = FunctionReturn<typeof functions.registerForeignToken>
...
export type TransferNativeTokenParams = FunctionArguments<typeof functions.transferNativeToken>
export type TransferNativeTokenReturn = FunctionReturn<typeof functions.transferNativeToken>
