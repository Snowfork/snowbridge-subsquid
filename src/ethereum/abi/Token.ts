...
export const functions = {
    ...
    GATEWAY: viewFun("0x338c5371", {}, p.address),
    ...
    mint: fun("0x40c10f19", {"account": p.address, "amount": p.uint256}, ),
    name: viewFun("0x06fdde03", {}, p.string),
    nonces: viewFun("0x7ecebe00", {"account": p.address}, p.uint256),
    permit: fun("0xd505accf", {"issuer": p.address, "spender": p.address, "value": p.uint256, "deadline": p.uint256, "v": p.uint8, "r": p.bytes32, "s": p.bytes32}, ),
